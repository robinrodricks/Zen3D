package zen.intersects
{
    ...
    public class SphereCollision 
    {
        ...
        private var pull:Vector.<CollisionInfo>;

        public function SphereCollision(source:ZenObject, radius:Number=1, offset:Vector3D=null)
        {
            ...
            this.pull = new Vector.<CollisionInfo>();
            super();
            this._src = source;
            this._radius = radius;
        ...
        private function addInfo(mesh:ZenMesh, poly:Poly3D, point:Vector3D, normal:Vector3D):CollisionInfo
        {
            var i:CollisionInfo = ((this.pull.length) ? this.pull.pop() : new CollisionInfo());
            i.mesh = mesh;
            i.poly = poly;
