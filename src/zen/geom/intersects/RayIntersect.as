package zen.geom.intersects {
	...
	public class RayIntersect {
		...
		private function addInfo(mesh:ZenMesh, surface:ZenFace, poly:Poly3D, point:Vector3D, normal:Vector3D):Intersection3D {
			var i:Intersection3D = ((this._pull.length) ? this._pull.pop() : new Intersection3D());
			i.mesh = mesh;
			i.surface = surface;
			i.poly = poly;
