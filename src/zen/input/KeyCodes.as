package zen.input {
	...
	public class KeyCodes {
		...
		public static const ArrowLeft:int = 37;
		public static const ArrowUp:int = 38;
		public static const ArrowRight:int = 39;
		public static const ArrowDown:int = 40;
		...
		public static const _3_Hash_Sharp:int = 51;
		public static const _4_Dollar:int = 52;
		public static const _5_Percentage:int = 53;
		public static const _6_UpArrow:int = 54;
		public static const _7_Ampersand:int = 55;
		public static const _8_Multiply:int = 56;
		public static const _9_RoundBracketOpen:int = 57;
		
		public static const SemicolonColon:int = 186;
		public static const EqualPlus:int = 187;
		public static const MinusUnderscore:int = 189;
		public static const SlashQuestion:int = 191;
		public static const AccentTilda:int = 192;
		public static const BracketSquareCurlyOpen:int = 219;
		public static const BackslashBar:int = 220;
		public static const BracketSquareCurlyClose:int = 221;
		public static const DoubleSingleQuote:int = 222;
		public static const CommaLessthan:int = 188;
		public static const DotMorethan:int = 190;
		...
		public static const NumpadMultiply:int = 106;
		public static const NumpadAdd:int = 107;
		public static const NumpadSubtract:int = 109;
		public static const NumpadDecimal:int = 110;
		public static const NumpadDivide:int = 111;
