package zen.display 
{
	...
	/**
	 * A stereo/anaglyph renderer extending the basic functionality of the Zen3D
	 */
	public class ZenStereo3D extends Zen3D 
	{
		...
		override public function render(camera:ZenCamera = null, clearDepth:Boolean = false, target:Texture3D = null ):void 
		{
