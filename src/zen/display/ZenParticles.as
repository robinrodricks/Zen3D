package zen.display
{
    ...
    public class ZenParticles extends ZenObject implements IDrawable 
    {
        ...
        public function ZenParticles(name:String="particles", texture:Texture3D=null)
        {
            ...
            this.texture = ((texture) || (new Texture3D(ZenUtils.nullBitmapData)));
        ...
        public function setColors(colors:Array, ratios:Array):void
        {
            ...
            this._colorTexture = ((this._colorTexture) || (new Texture3D(new BitmapData(0x0100, 16, true, 0xFFFFFFFF))));
