package zen.filters.maps {
	...
	/** A material filter that uses a bitmap to specify which portions of the texture are visible */
	public class TextureMaskFilter extends ShaderFilter {
		...
		public function TextureMaskFilter(texture:ZenTexture = null, channel:int = 0, threshold:Number = 0.5, technique:String = "alpha") {
			if (data == null) {
