package zen.filters.maps {
	...
	/** A material filter that uses a bitmap for environment mapping */
	public class EnvironmentMapFilter extends ShaderFilter {
		...
		public function EnvironmentMapFilter(texture:ZenTexture = null, blendMode:String = "multiply", alpha:Number = 1, techniqueName:String = "perPixel") {
			if (data == null) {
