package zen.materials
{
    ...
    public class Texture3D extends EventDispatcher implements ILibraryItem 
    {
		 ...
		 * 
		 * */
        public function Texture3D(request=null, optimizeForRenderToTexture:Boolean=false, format:int=0, type:int=0)
        {
            var d:DisplayObject;
            var r:Rectangle;
            var m:Matrix;
