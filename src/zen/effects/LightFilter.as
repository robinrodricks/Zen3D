package zen.effects
{
    ...
    public class LightFilter extends ShaderFilter 
    {
        ...
        private var _filterMapTexture:Texture3D;
        private var _shadowMapTexture:Texture3D;
        ...
        public function LightFilter(techniqueName:String="sampled", maxPointLights:int=0, maxDirectionalLights:int=1, useDefaultLights:Boolean=false)
        {
            ...
            this._texture = new Texture3D(new BitmapData(this._textureRect.width, this._textureRect.height, true, 0));
        ...
        public function renderShadows():Boolean
        {
            ...
            if (!(this._shadowMapTexture)){
                this.shadowMapTexture = new Texture3D(new Rectangle(0, 0, 0x0800, 0x0400));
            }
            if (this.enableShadowsFiltering){
                if (!(this._filterMapTexture)){
                    this._filterMapTexture = new Texture3D(this._shadowMapTexture.request, true);
                }
                if (!(this._diskFilter)){
